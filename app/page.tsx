...
export default function Home() {
  ...
  // --- ZOOM LOGIC ---
  // Adjusted slightly: Zoom finishes by 20% of scroll so it's ready for Page 2 & 3
  ...
  const projects = [
    { 
      id: "001", title: "Capstone Project", tech: "Next.js / Firebase", 
      desc: "A Web-Based and Mobile System​ for Pet Health Management and Veterinary Clinic Operations​",
      link: "/project/001", imgSrc: "/furevercare.png" 
    },
    { 
      id: "002", title: "Pulse AI", tech: "React / OpenAI", 
      desc: "Real-time market analysis tool leveraging large language models for sentiment signals.",
      link: "/project/002"
    },
    { 
      id: "003", title: "Echo Social", tech: "Web3 / Solidity", 
  ...
  return (
    <div className="bg-transparent text-white selection:bg-blue-600 font-sans overflow-x-hidden relative">
      ...
      {/* --- PAGE 4: PROJECTS --- */}
      {/* Added z-20 to ensure it sits ON TOP of the fixed image */}
      <section className="relative z-20 py-32 px-4 md:px-20 bg-[#050505]">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-5xl md:text-7xl font-black mb-20 italic uppercase tracking-tighter text-white">Selected Works</h2>
            ...
            {projects.map((project, i) => (
              ...
              >
                ...
                <div className="absolute right-0 top-0 w-full md:w-[40%] h-full p-10 flex flex-col justify-center items-end text-right z-30 opacity-0 translate-x-10 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-500 delay-100">
                  ...
                  <Link href={project.link} target="_blank" className="inline-flex items-center gap-3 px-8 py-3 border border-white/30 rounded-full backdrop-blur-sm text-white font-bold uppercase tracking-widest text-xs hover:bg-white hover:text-black hover:border-white transition-all duration-300 shadow-xl">Explore Project ↗</Link>
                </div>
              </motion.div>
            ))}
          </div>
